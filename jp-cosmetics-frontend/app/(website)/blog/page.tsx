                ...
                <Link key={post.id} href={`/blog/${post.id}`} className="cursor-pointer">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all group h-full flex flex-col">
                    ...
                    <div className="p-5 flex-1 flex flex-col">
                      ...
                      <p className="text-gray-600 text-sm mb-4 line-clamp-2 flex-1 font-medium">
                        {post.excerpt}
                      </p>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {popularTags.map((tag, index) => (
                  <button
                    key={index}
                    className="px-3 py-1.5 bg-gray-100 hover:bg-gradient-to-r hover:from-pink-500 hover:to-rose-600 hover:text-white text-gray-700 text-sm rounded-full transition-all cursor-pointer font-medium"
                  >
                    #{tag}
                  </button>
                ))}
            ...
            <div className="bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl shadow-md p-6 text-white">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-white border border-rose-200 text-white"
                />
