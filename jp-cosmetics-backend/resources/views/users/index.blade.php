            ...
            <tbody>
                @foreach($users as $admin)
                    ...
                    <a href="{{ route('users.edit', $admin->id) }}">
                        <button class="flex items-center gap-2 px-8 py-2 rounded-xl text-sm font-medium bg-blue-500 text-white hover:bg-blue-600 shadow-md transition">Edit</button>
                    </a> 
                    @endHasPermission  
                </td>            
                    </tr>
