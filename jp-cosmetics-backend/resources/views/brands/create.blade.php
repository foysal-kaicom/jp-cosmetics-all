...
<div class="rounded shadow-sm">
    <div class="p-3 rounded-top" style="background-color: rgb(119, 82, 125); color:#ffffff">
        <h3 class="fs-5">Create Brand</h3>
    </div>

    <!-- Form Start -->
    <form action="{{ route('brand.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-bottom">
        @csrf
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="position-relative border rounded bg-light d-flex align-items-center justify-content-center h-75">
                    <img id="imagePreview" src="{{ asset('imagePH.png') }}" alt="Logo Preview" class="w-100 h-100 object-fit-cover rounded"/>
            ...
            <div class="col-md-9 mt-10">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input required type="text" name="name" id="name" class="form-control" placeholder="Enter Brand Name" value="{{ old('name') }}" />
                        @error('name')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>

                    <!-- (Optional) You can add more fields here later -->
                </div>
