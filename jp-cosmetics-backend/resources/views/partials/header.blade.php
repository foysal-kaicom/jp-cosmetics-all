<header class="flex items-center justify-between px-2 py-2 bg-slate-100" style="background-color: rgb(251, 243, 252)">
    ...
    <div class="flex gap-3 items-center text-gray-600">
        ...
        <div class="dropdown">
            <img src="{{ Auth::user()->image 
                ?  Auth::user()->image 
                : 'https://via.placeholder.com/40' }}" alt="User" class="rounded-circle border dropdown-toggle"
