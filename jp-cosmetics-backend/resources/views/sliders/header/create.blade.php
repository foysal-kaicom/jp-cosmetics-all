...
<div class="rounded shadow-sm">
    <div class="p-3 rounded-top" style="background-color: rgb(119, 82, 125); color:#ffffff">
        <h3 class="fs-5">Add Header Slider</h3>
    </div>

    <form action="{{ route('header-sliders.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-bottom">
        @csrf
        ...
        <div class="row g-4">
            <div class="col-md-3 text-center">
                ...
                <div class="position-relative border rounded bg-light d-flex align-items-center justify-content-center h-75">
                    <img id="imagePreview" src="{{ asset('imagePH.png') }}" class="w-100 h-100 object-fit-cover rounded"/>
